  ...
  return (
    <div className="fixed bottom-6 right-5 z-40 lg:hidden flex items-center justify-center">
      ...
      <a
        ...
        className="relative w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-2xl shadow-black/70 border-2 border-white/40 active:scale-90 transition-all duration-300 hover:brightness-110"
      >
        <svg
          viewBox="0 0 24 24"
